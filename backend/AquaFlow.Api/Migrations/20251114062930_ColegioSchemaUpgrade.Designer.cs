...
namespace AquaFlow.Api.Migrations
{
    ...
    [Migration("20251114062930_ColegioSchemaUpgrade")]
    partial class ColegioSchemaUpgrade
    {
        /// <inheritdoc />
                    ...
                    b.ToTable("colegios", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_colegios_nivel", "nivel IN ('inicial','primaria','secundaria','combinado')");
                        });
                });
